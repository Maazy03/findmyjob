...
const GridTables = (props) => {
  ...
  useEffect(() => {
    setStateForArts(reduxArtsState.masterPieceArts);
  });
  ...
  async function getData(area) {
    ...
    let get = await dispatch(productActions.getMasterPieceArts(index));
    setStateForArts(get);
      ...
      >
        {laoding ? (
          ...
          <Fragment>
            ...
            <TablePagination tableName={"masterpiece"} area={region} />
          </Fragment>
        )}
      </ReactCSSTransitionGroup>
    </Fragment>
