...
const mapStateToProps = (state) => {
  console.log("SIGN UP OTP STATE", state.auth.signupEmailData)
  return {
...
export default connect(mapStateToProps, mapDispatchToProps)(SignupOTPBoxed);
