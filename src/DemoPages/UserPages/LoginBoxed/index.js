        ...
        <div className={classes.paper}>
          ...
          <TextField
            ...
            <Button
              ...
              disabled={!state.email || state.password.length <= 7 || stateLoader} >
              {stateLoader ? (
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    login: (LOGIN_DATA, navigate, stopLoader) => dispatch(login(LOGIN_DATA, navigate, stopLoader))
  };
};
