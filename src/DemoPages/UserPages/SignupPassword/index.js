...
import { signupPassword } from "../../../store/actions/authActions"
...
const useStyles = makeStyles((theme) => ({
 ...
 function SignupPasswordBoxed(props) {
  ...
  const handleSubmit = (e) => {
    ...
    const SIGNUP_PASSWORD_DATA = {
     email:loggedemail,
    password:state.password
    };
    
    console.log("SIGN UP PASSWORD INDEX",SIGNUP_PASSWORD_DATA)

    props.signupPassword(SIGNUP_PASSWORD_DATA, () => {
      props.history.push({
        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate>
            ...
            <Button
              ...
              disabled={state.password.length <= 7 || stateLoader}
            >
              {stateLoader ? (
...
const mapStateToProps = (state) => {
  console.log("SIGN UP PASSWORD STATE",state)
  return {
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    signupPassword: (SIGNUP_PASSWORD_DATA,navigate,stopLoader) => dispatch(signupPassword(SIGNUP_PASSWORD_DATA,navigate,stopLoader))
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(SignupPasswordBoxed);
