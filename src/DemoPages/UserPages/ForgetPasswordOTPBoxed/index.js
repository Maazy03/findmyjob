...
function ForgetPasswordOTPBoxed(props) {
  ...
  console.log("FORGET PASSWORD OTP INDEX", state.OTPpin.length==6)
  const handleSubmit = (e) => {
    ...
    props.signupOTP(FORGET_PASSWORD_OTP, () => {
      props.history.push({
        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate>
            ...
            <Button
              ...
              variant="contained"
              color="primary"
              disabled={state.OTPpin.length!==6 || stateLoader}
...
export default connect(mapStateToProps, mapDispatchToProps)(ForgetPasswordOTPBoxed);
